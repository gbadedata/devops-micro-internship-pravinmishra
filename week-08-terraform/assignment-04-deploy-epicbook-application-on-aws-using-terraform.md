...
![Terraform version](./screenshots/a4-01-terraform-version.png)
...
![AWS CLI version](./screenshots/a4-02-aws-version.png)
...
![HashiCorp Terraform extension in VS Code](./screenshots/a4-03-vscode-terraform-extension.png)
...
![Modular project structure](./screenshots/a4-04-project-structure.png)

---

Terraform project: [`terraform-aws-epicbook/`](./terraform-aws-epicbook/) (root module plus `modules/network`, `modules/ec2` and `modules/rds`)
...
![VPC and subnets](./screenshots/a4-05-vpc-subnets.png)
...
![Internet Gateway and public routing](./screenshots/a4-06-igw-routing.png)
...
![EC2 and RDS security groups](./screenshots/a4-07-security-groups.png)
...
![Network module outputs](./screenshots/a4-08-network-outputs.png)
...
![EC2 resource and user_data](./screenshots/a4-09-ec2-user-data.png)
...
![user_data.sh](./screenshots/a4-10-user-data-sh.png)
...
![EC2 module variables and outputs](./screenshots/a4-11-ec2-vars-outputs.png)
...
![DB subnet group and RDS MySQL](./screenshots/a4-12-rds-subnet-group-mysql.png)
...
![Private RDS and sensitive variables](./screenshots/a4-13-rds-private-sensitive.png)
...
![RDS endpoint output](./screenshots/a4-14-rds-endpoint-output.png)
...
![Root module blocks](./screenshots/a4-15-root-modules.png)
...
![Values passed between modules](./screenshots/a4-16-values-between-modules.png)
...
![Root outputs](./screenshots/a4-17-root-outputs.png)
...
![terraform init](./screenshots/a4-18-terraform-init.png)
...
![terraform validate](./screenshots/a4-19-terraform-validate.png)
...
![terraform plan](./screenshots/a4-20-terraform-plan.png)
...
![terraform apply](./screenshots/a4-21-terraform-apply.png)
...
![terraform output](./screenshots/a4-22-terraform-outputs.png)
...
![EC2 running](./screenshots/a4-23-ec2-running.png)
...
![Private RDS available](./screenshots/a4-24-rds-private-available.png)
...
![Installed software and Nginx](./screenshots/a4-25-software-nginx.png)
...
![EC2 to RDS connection](./screenshots/a4-26-ec2-to-rds.png)
...
![EpicBook tables and imported data](./screenshots/a4-27-tables-data.png)
...
![Dependencies and node_modules](./screenshots/a4-28-dependencies.png)
...
![Nginx configuration and service](./screenshots/a4-29-nginx-config.png)
...
![EpicBook on port 8080](./screenshots/a4-30-epicbook-8080.png)
...
**EC2 Public IP URL:** http://18.134.226.26 (verified working during testing; the instance was destroyed afterwards as required in Task 11)
...
![EpicBook through the EC2 public IP](./screenshots/a4-31-epicbook-browser.png)
...
![Cart action](./screenshots/a4-32-cart-action.png)
...
![Corresponding RDS cart record](./screenshots/a4-33-rds-cart-record.png)
...
![terraform destroy](./screenshots/a4-34-terraform-destroy.png)
...
Not applicable: I chose not to publish a LinkedIn post for this assignment.
