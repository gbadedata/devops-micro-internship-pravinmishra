...
![Terraform version](./screenshots/a1-01-terraform-version.png)

---

#### Screenshot 2 — Terminal showing successful `az version` output

![Azure CLI version](./screenshots/a1-02-az-version.png)

---

#### Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled

![HashiCorp Terraform extension in VS Code](./screenshots/a1-03-vscode-terraform-extension.png)
...
![AzureRM provider and resource group in main.tf](./screenshots/a1-04-main-provider-rg.png)
...
![Linux VM and public IP output in main.tf](./screenshots/a1-05-main-vm-output.png)

---

Terraform configuration: [`terraform-azure-vm/main.tf`](./terraform-azure-vm/main.tf)
...
![terraform init](./screenshots/a1-06-terraform-init.png)
...
![terraform plan](./screenshots/a1-07-terraform-plan.png)

---

#### Screenshot 8 — Terraform apply output showing successful completion

![terraform apply](./screenshots/a1-08-terraform-apply.png)

---

#### Screenshot 9 — Terraform output showing the public IP address of the VM

![terraform output](./screenshots/a1-09-terraform-output.png)

### Question

VM Public IP Address: **51.137.190.37**
...
![Azure CLI showing VM running](./screenshots/a1-10-az-vm-running.png)
...
![terraform destroy](./screenshots/a1-11-terraform-destroy.png)
